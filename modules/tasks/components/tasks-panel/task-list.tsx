...
export const TaskList = {
  ...
  Row: ({ className, ...props }: HTMLAttributes<HTMLDivElement>) => <Div className={cn("flex items-center gap-2", className)} {...props} />,
  Meta: ({ className, ...props }: HTMLAttributes<HTMLDivElement>) => <Div className={cn("ml-auto flex shrink-0 items-center gap-1 self-center text-xs text-sage-700", className)} {...props} />,
  ...
  StepRow: ({ className, ...props }: HTMLAttributes<HTMLDivElement>) => <Div className={cn("flex items-center gap-2", className)} {...props} />,
