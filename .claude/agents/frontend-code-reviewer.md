...
1. Read the project's root `CLAUDE.md` and the app-specific `CLAUDE.md` (`dashboard/CLAUDE.md`, `storefront/CLAUDE.md`, or `storefront-v2/CLAUDE.md`) to pick up project-specific conventions.
